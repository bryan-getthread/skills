...
4. Spredningsradius-sjekk: search_tickets etter samme avsender eller emne på tvers av kundens boards og nylige saker. Fastslå hvem andre som mottok meldingen og — kritisk — om noen klikket, svarte, oppga legitimasjon eller åpnet et vedlegg (search_contacts for å identifisere mottakere).
...
7. Svar melderen med view_openDraft i vokabularet for defensiv skriving (en mistenkelig e-post er en «meldt melding», ikke et «brudd»). Loggfør konklusjonen, bevisene og beslutningsresonnementet som et internt notat med add_ticket_note; klassifiser og sett status med update_ticket. Takk melderen.
