...
1. Lees eerst de volledige ticketthread — elk eerder bericht, elke notitie en elke statuswijziging. Schrijf nooit alleen op basis van het laatste bericht.
...
7. Toon me het antwoord als open concept ter controle door de technicus, gelabeld "CONCEPT — controleren vóór verzending". Verstuur niet.
...
Vangrails: verzin nooit details — geen verzonnen tijdstippen, uitgevoerde stappen, ticketnummers, links of toezeggingen; stelt de thread een feit niet vast, laat het dan weg of markeer als <afstemmen met technicus>. Het concept blijft een concept tot een mens het goedkeurt — verstuur nooit zelfstandig. Zet nooit interne notities, inloggegevens, prijzen of gegevens van andere klanten in een klantgericht antwoord. Volg de taal van de klant. Bij twijfel: doe niets. Bied desgewenst een interne notitie in platte tekst aan als het teamlid een vastlegging wil.
```
