...
Running as a Flow (trigger: a scheduled sweep or an incident-close event incrementing a
known signature): create only when the threshold is met by strict signature match — same
