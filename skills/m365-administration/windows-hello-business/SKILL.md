...
7. Document. Plain-text note (add_ticket_note): trust model, scope, policy settings, approver, pilot verification results (including the hybrid resource test), comms sent, and rollback reference. Schedule the ring-broadening steps (schedule_ticket).
