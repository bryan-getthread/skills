...
6. Book it: schedule_ticket for the agreed window and assign the implementing tech via update_ticket. After implementation, the ticket should carry a verification note before closure.
