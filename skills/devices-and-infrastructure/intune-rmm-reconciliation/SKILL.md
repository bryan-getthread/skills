...
1. Resolve the client organization in the RMM (list_ninjaone_organizations or connectwise_rmm_list_companies) and pull its full device list (search_ninjaone_devices / connectwise_rmm_search_devices). If a listing may have capped, report the count as "at least N".
