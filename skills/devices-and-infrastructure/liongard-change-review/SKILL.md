...
7. Output: the change list ranked by relevance (system, change, when, detected by), ticket correlations with strength, unexplained high-risk changes called out, recommended follow-ups. Offer a plain-text note via add_ticket_note (no markdown/emojis).
