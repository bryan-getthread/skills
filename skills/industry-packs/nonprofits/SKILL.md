...
1. Context: search_tickets for this org + app history, and search_itglue / search_hudu for the stack: donor CRM, licensing sources (grant vs paid, TechSoup records), giving-platform inventory, and the org's designated approver for access and spending. Docs tools vary per tenant — if absent, say what you could NOT verify; an org with no recorded license sources or access approver is a flag worth raising.
